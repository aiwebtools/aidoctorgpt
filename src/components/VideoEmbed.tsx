...
const VideoEmbed: React.FC = () => {
  ...
  return (
    <div className="w-full flex justify-center my-8">
      <div className="w-full max-w-3xl rounded-lg overflow-hidden border border-purple-600/30 shadow-lg aspect-video bg-black pointer-events-none md:pointer-events-auto" style={{ touchAction: 'pan-y' }}>
