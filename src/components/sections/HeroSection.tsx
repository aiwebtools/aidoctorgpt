  ...
  return (
    <div className="relative overflow-hidden pt-24 sm:pt-32 pb-16 sm:pb-24">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-72 h-72 rounded-full bg-cyan-500/10 blur-3xl" style={{animationDelay: '1.5s', animationDuration: '7s'}}></div>
        
        {/* Animated particles */}
        <div className="absolute top-20 left-[20%] w-2 h-2 rounded-full bg-purple-500/70 animate-float" style={{animationDuration: '3s'}}></div>
        <div className="absolute top-40 left-[70%] w-2 h-2 rounded-full bg-cyan-400/70 animate-float" style={{animationDuration: '5s', animationDelay: '1s'}}></div>
        <div className="absolute top-60 left-[30%] w-3 h-3 rounded-full bg-pink-500/70 animate-float" style={{animationDuration: '4s', animationDelay: '0.5s'}}></div>
          ...
          <div className="flex-1 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <AnimatedButton 
                ...
                className="bg-black/30 border-purple-500/30 backdrop-blur-sm text-white hover:bg-black/40 hover:border-purple-500/50"
              >
                Veterinarian GPT
              </AnimatedButton>
            </div>
            ...
            <div className="flex flex-wrap gap-6 text-sm text-neutral-400">
              <div className="flex items-center group hover-scale">
                ...
                <span className="group-hover:text-neutral-300 transition-colors">HIPAA Compliant</span>
              </div>
              <div className="flex items-center group hover-scale">
                <Users className="h-5 w-5 text-purple-400 mr-2 group-hover:text-purple-300 transition-colors" />
                <span className="group-hover:text-neutral-300 transition-colors">100,000+ Users</span>
              </div>
              <div className="flex items-center group hover-scale">
                <Heart className="h-5 w-5 text-purple-400 mr-2 group-hover:text-purple-300 transition-colors" />
                <span className="group-hover:text-neutral-300 transition-colors">Trusted by Doctors</span>
              </div>
              <div className="flex items-center group hover-scale">
                <Star className="h-5 w-5 text-purple-400 mr-2 group-hover:text-purple-300 transition-colors" />
                <span className="group-hover:text-neutral-300 transition-colors">4.9/5 Rating</span>
              </div>
            </div>
          </div>
              ...
              <div className="mt-6 pt-4 border-t border-neutral-800">
                <div className="flex items-center rounded-full border border-purple-500/30 pl-4 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 backdrop-blur-sm bg-black/20">
                  <input
                    ...
                    className="w-full bg-transparent border-none focus:outline-none text-sm py-2 text-neutral-300"
                    onClick={handleChatRedirect}
                    readOnly
                  />
                  <button 
                    className="ml-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full p-2 hover:shadow-glow transition-shadow duration-300"
                    onClick={handleChatRedirect}
                  >
